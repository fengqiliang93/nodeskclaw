const enUS = {
  ...
  hexAction: {
    ...
    humanHex: "Human Seat",
    addAgentHere: "Add Agent to this slot",
  ...
  chat: {
    ...
    inputPlaceholder: "Type a message, {'@'} to mention Agent, / for commands",
    slugCopied: "Instance slug copied",
    cmdStatusLabel: "Show all Agent statuses",
    cmdClearLabel: "Clear chat history",
    cmdRestartLabel: "Restart Agent",
    cmdRemoveLabel: "Remove Agent",
    ...
    agentNotFound: "Agent not found: {name}",
    ...
    agentRemoved: "{name} removed from workspace",
  ...
  createWorkspace: {
    ...
    descriptionLabel: "Description",
    descriptionPlaceholder: "Briefly describe the purpose of this workspace...",
    themeColor: "Theme Color",
    previewNameFallback: "Workspace Name",
