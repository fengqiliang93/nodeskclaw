const enUS = {
  ...
  auth: {
    ...
    codeLoginHint: "Unregistered phone numbers will auto-create an account; email requires registration and org SMTP configuration",
  },
  orgSetup: {
  ...
  orgSettings: {
    ...
    smtpConfigTab: "Email config",
    smtpTitle: "SMTP Email Configuration",
    smtpDescription: "Configure your organization's SMTP server for sending verification code emails and notifications.",
    smtpEmpty: "SMTP not configured",
    smtpEmptyHint: "Configure SMTP to enable email verification code login",
    smtpHost: "SMTP server",
    smtpPort: "Port",
    smtpUsername: "Username",
    smtpPassword: "Password",
    smtpPasswordPlaceholder: "SMTP password or app password",
    smtpPasswordHint: "Leave empty to keep the current password",
    smtpPasswordRequired: "Please enter the SMTP password",
    smtpFromEmail: "From email",
    smtpFromName: "From name",
    smtpFromNamePlaceholder: "e.g. DeskClaw (optional)",
    smtpUseTls: "Enable TLS encryption",
    smtpSave: "Save configuration",
    smtpSaved: "SMTP configuration saved",
    smtpSaveFailed: "Failed to save",
    smtpFillRequired: "Please fill in required fields",
    ...
    smtpDeleteFailed: "Failed to delete",
  },
  enterpriseFiles: {
