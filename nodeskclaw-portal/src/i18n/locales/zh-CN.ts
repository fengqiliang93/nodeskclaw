const zhCN = {
  ...
  auth: {
    ...
    codeLoginHint: "手机号未注册将自动创建账户；邮箱需已注册且所属组织配置了 SMTP",
  },
  orgSetup: {
    title: "开通企业空间",
  ...
  orgSettings: {
    ...
    smtpConfigTab: "邮件配置",
    smtpTitle: "SMTP 邮件配置",
    smtpDescription: "配置组织的 SMTP 服务器，用于发送验证码邮件等通知。",
    smtpEmpty: "尚未配置 SMTP",
    smtpEmptyHint: "配置后可使用邮箱验证码登录功能",
    smtpHost: "SMTP 服务器",
    smtpPort: "端口",
    smtpUsername: "用户名",
    smtpPassword: "密码",
    smtpPasswordPlaceholder: "SMTP 密码或授权码",
    smtpPasswordHint: "留空则保留原密码不变",
    smtpPasswordRequired: "请输入 SMTP 密码",
    smtpFromEmail: "发件人邮箱",
    smtpFromName: "发件人名称",
    smtpFromNamePlaceholder: "如：DeskClaw（可选）",
    smtpUseTls: "启用 TLS 加密",
    smtpSave: "保存配置",
    smtpSaved: "SMTP 配置已保存",
    smtpSaveFailed: "保存失败",
    smtpFillRequired: "请填写必填项",
    smtpTest: "发送测试邮件",
