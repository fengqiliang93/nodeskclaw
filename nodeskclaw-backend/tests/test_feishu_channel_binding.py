...
async def test_apply_feishu_node_selector_clears_conflicting_local_pvc_selector(monkeypatch) -> None:
    instance = SimpleNamespace(
        name="xprecise-feishu-bot-test",
        slug="xprecise-feishu-bot-test",
        namespace="nodeskclaw-default-xprecise-feishu-bot-test",
    ...
    k8s.apps.patch_namespaced_deployment.assert_awaited_once_with(
        "xprecise-feishu-bot-test",
        "nodeskclaw-default-xprecise-feishu-bot-test",
